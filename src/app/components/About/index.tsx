...
export default function About() {
  ...
  return (
    <section className='container mt-28 mb-10 px-6 sm:px-0'>
      <Title text='SOBRE' />
      <div className='flex flex-col xl:flex-row gap-10'>
        <article>
          ...
          <div className='sm:grid grid-cols-2 mt-4 gap-4 hidden'>            
            <article className='sm:border-none transition-all ease-out duration-500 text-zinc-50 border rounded border-primary-400 p-4 pl-0'>  
            ...
            <article className='sm:border-none transition-all ease-out duration-500 text-zinc-50 border rounded border-primary-400 pt-4'>  
              <div className='flex items-center justify-between'>
                <figure className='flex items-center gap-4'>
                  <img src={'/icons/vision.svg'} alt={'Visão'} />
